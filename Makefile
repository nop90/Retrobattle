...
APP_TITLE		:= Retrobattle
APP_DESCRIPTION	:= Retrobattle is made to look and feel like the classic arcade-style NES games, with makes a challenging arcade experience that mixes various oldschool concepts.
...
CXXFLAGS	:= $(CFLAGS) -fno-rtti -fno-exceptions -std=gnu++11 -findirect-inlining -fpermissive -DCITRA_CONSOLE_OUTPUT
